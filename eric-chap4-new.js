...
const x = document.querySelector(".choice-tool");
...
function gameCompare(pilihanUser) {
    ...
    console.log("Hasil player 1 => " + pilihanUser);
...
function play() {
    rock_user.addEventListener('click', function () {
        //untuk merubah warna background ketika dipilih buat class di css, tapi panggilnya di sini 
        this.classList.add('chosen');
        gameCompare("Batu");
        addElement1.forEach(item => {
            //untuk memblok supaya ga bisa ditekan lagi
            item.setAttribute("style", "cursor: not-allowed;pointer-events: none;")
        })
